...
/* [3][VFATCONF:|Erreur d'‚criture.][Abandon] */

#define ALRT_NO_INF        1 /* Alert string */
/* [3][Il n'y a pas de MAGX.INF|sur le lecteur de boot.|Veuillez en cr‚‚r un, par|exemple avec MAGXDESK!][Abandon] */

#define ALRT_MEMERR        2 /* Alert string */
/* [3][M‚moire insuffisant pour le|chargement de MAGX.INF.][Abandon] */
