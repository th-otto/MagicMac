/*
 * GEM resource C output of magxconf
 *
...
extern char magxconf_string_0[];
extern char magxconf_string_1[];
extern char magxconf_string_2[];
extern char magxconf_string_3[];
extern char magxconf_string_4[];
extern char magxconf_string_5[];
extern char magxconf_string_6[];
extern char magxconf_string_7[];
extern char magxconf_string_8[];
extern char magxconf_string_9[];
...
/* MAIN */
	...
	{ 12, -1, -1, G_BUTTON, 0x607, OS_WHITEBAK, C_UNION(magxconf_string_8), 12,1801, 8,513 }, /* OK */
	{ 0, -1, -1, G_BUTTON, 0x625, OS_WHITEBAK, C_UNION(magxconf_string_9), 1558,1801, 8,257 } /* CANCEL */
};
...
static char magxconf_string_4[] = "Grow- und Shrinkboxen";
static char magxconf_string_5[] = "Floppy-Hintergrund-DMA";
static char magxconf_string_6[] = "Pull-Down-Men\201s";
...
#ifdef __STDC__
_WORD magxconf_rsc_load(_WORD wchar, _WORD hchar)
#else
_WORD magxconf_rsc_load(wchar, hchar)
_WORD wchar;
_WORD wchar;
#endif
{
...
#ifdef __STDC__
_WORD magxconf_rsc_gaddr(_WORD type, _WORD idx, void *gaddr)
#else
_WORD magxconf_rsc_gaddr(type, idx, gaddr)
_WORD type;
_WORD idx;
void *gaddr;
#endif
...
#ifdef __STDC__
_WORD magxconf_rsc_free(void)
#else
_WORD magxconf_rsc_free()
#endif
{
#if NUM_OBS != 0
