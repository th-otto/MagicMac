...
static const char *const preserve[] = {
	"CHGRES.PRG",
	"CHGRES.RSC",
	"APPLICAT.DAT",
	"APPLICAT.INF",
...
static long walk_path(char *path, long (*before)(char *path, DTA * file), long(*after)(char *path, DTA * file))
{
	long errcode;
