...
#else
extern struct res *nvdipc_modes[NUM_NVDIPC];
extern short nvdipc_driver_ids[NUM_NVDIPC];
extern short const nvdipc_planes[NUM_NVDIPC];
#endif
...
extern struct res *magicpc_res_table[MAX_DEPTHS];
...
extern const char *const nvdipc_driver_names[NUM_NVDIPC];
