...
#define CHGRES_INFO                       20 /* BUTTON in tree MAIN_DIALOG */
#define CHGRES_NEW                        21 /* BUTTON in tree MAIN_DIALOG */
#define CHGRES_OK                         22 /* BUTTON in tree MAIN_DIALOG */
#define CHGRES_CANCEL                     23 /* BUTTON in tree MAIN_DIALOG */
...
#define INFO_STR_PULSE                    10 /* STRING in tree INFO_DIALOG */
#define INFO_FREQ                         11 /* STRING in tree INFO_DIALOG */
#define INFO_STR_MHZ                      12 /* STRING in tree INFO_DIALOG */
#define INFO_STR_HZ                       13 /* STRING in tree INFO_DIALOG */
#define INFO_VIRT_BOX                     14 /* BUTTON in tree INFO_DIALOG */
#define INFO_VIRT_HRES                    15 /* FTEXT in tree INFO_DIALOG */
#define INFO_VIRT_VRES                    16 /* FTEXT in tree INFO_DIALOG */
#define INFO_OK                           17 /* BUTTON in tree INFO_DIALOG */
