...
;******************************************************************************;
;*                                                                            *;
;*             Farb-Bildschirmtreiber fuer NVDI 3.0                           *;
;*                                                                            *;
;******************************************************************************;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
scrninfo:         DC.W 2                  ;Packed Pixels
                  ...
                  DC.W  10,11,12,13,14    ;Bits der Rot-Intensitaet
                  DCB.W 11,-1
...
palette_data:     DC.W $7fff,$7c00,$03e0,$7fe0,$001f,$7c1f,$03ff,$6b5a
                  DC.W $4210,$5400,$02a0,$56a0,$0015,$5415,$02b5,$0000
...
init_res:         movem.l  d0-d2/a0-a2,-(sp)
                  ...
                  move.w   #16,PLANES.w   ;Anzahl der Bildebenen
...
;Ausgaben:
;-
wk_init:          move.l   x_res,res_x(a6) ;Aufloesung
...
dev_name:         DC.B  'Mac 32768 Farben',0
                  EVEN
