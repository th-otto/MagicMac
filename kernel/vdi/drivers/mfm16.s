...
vt_n_column:      move.w   V_CUR_XY0.w,d0
                  ...
                  bge.s    vt_l_column
                  addq.l   #4,V_CUR_AD.w  ;naechste Spalte
...
vt_set_col:       and.w    #$0f,d1        ;ausmaskieren
                  move.w   d1,(a1)
                  move.l   #vt_con,con_state.w ;Sprungadresse
                  rts
...
draw_spr_saddr:   movea.l  a1,a4          ;Zeilenadresse
                  ...
                  movea.w  BYTES_LIN.w,a3
                  lea      -12(a3),a3     ;Abstand zur naechsten Zeile
                  move.w   d3,d5

draw_spr_sloop:   REPT 3
                  move.l   (a4)+,(a2)+
                  ENDM
                  adda.w   a3,a4
...
draw_spr_nth:     ror.b    #4,d1
                  ror.b    #4,d6
                  ror.b    #4,d7
                  cmp.b    #$0f,d1
                  bne.s    draw_sprna
                  addq.l   #1,a1
draw_sprna:       dbra     d2,draw_spr_loop
