...
scrninfo_int:      DC.W 2,3,4,5,6          ;Bits der Rot-Intensitaet
                  DCB.W 11,-1
...
scrninfo_mot:     DC.W 10,11,12,13,14      ;Bits der Rot-Intensitaet
                  DCB.W 11,-1
                  DC.W 5,6,7,8,9          ;Bits der Gruen-Intensitaet
                  DCB.W 11,-1
                  DC.W 0,1,2,3,4          ;Bits der Blau-Intensitaet
                  DCB.W 11,-1
                  DCB.W 16,-1             ;kein Alpha-Channel
                  DCB.W 16,-1             ;keine Bits fuer Genlock
                  DC.W  15                ;Bit 15 ist unbenutzt
                  DCB.W 31,-1             ;unbenutzte Bits
...
set_pattern_loop: move.l   (a0)+,d0       ;32-Bit-True-Color-Fuellmuster
                  ...
                  move.w   d0,d1
                  lsr.l    #3,d1          ;Gruen-Intensitaet auf 5 Bits verkleinern
                  move.b   d0,d1
...
hline_solid:      sub.w    d0,d2
                  lsr.w    #1,d2
                  bcs.s    hline_sld_loop
                  
                  move.w   d4,(a1)+
                  subq.w   #1,d2
                  bmi.s    hline_sld_exit
                  
hline_sld_loop:   move.l   d4,(a1)+
...
fbox_universal:   move.w   wr_mode(a6),d7
                  ...
                  bne.s    fbox_opt
                  move.l   #$7fff7fff,d7  ;weiss als Farbe benutzen
                  bra      fbox_solid
