...
;******************************************************************************;
;*                                                                            *;
;*                      4-Farb-Bildschirmtreiber fuer NVDI 3.0                *;
;*                                                                            *;
;******************************************************************************;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
init_res:         movem.l  d0-d2/a0-a2,-(sp)
                  ...
                  bra.s    init_res_set
init_res_vd:      lea      out_st_mid(pc),a2
                  cmp.w    #ST_VIDEO,d0
                  beq.s    init_res_set
                  lea      out_tt_ste_mid(pc),a2
...
out_tt_ste_mid:   DC.W 278,556,4,1,4096   ; 1 TT 640*200
out_st_mid:       DC.W 278,556,4,1,512    ; 1 ST 640*200
...
;Farbpaletten
palette:          DC.W $0fff,$0f00,$00f0,$0000
...
dev_name:         DC.B  'Bildschirm 4 Farben',0
                  EVEN
...
vdi_palette:      DS.W  12                ;Palette zum Speichern der VDI-Farbintesitaeten
