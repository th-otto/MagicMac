...
vro_src:          move.l   fd_addr(a4),r_saddr(a6) ;Quelladresse
                  ...
                  cmp.w    r_planes(a6),d7     ;Geraet mit mehr als 8 Planes?
                  bge.s    vro_src_planes
                  move.w   r_planes(a6),d7     ;AES-Fehler korrigieren
...
vro_des:          move.l   fd_addr(a5),r_daddr(a6) ;Zieladresse
...
vro_width:        exg      d2,d4
                  ...
                  cmp.w    r_planes(a6),d6  ;Planeanzahl abweichend von der des Geraets?
...
vro_cpyfm_mono:   tst.w    d6             ;monochrom?
                  ...
                  move.l   (mono_bitblt).w,d6 ;Treiber vorhanden?
...
vrt_src:          move.l   fd_addr(a4),r_saddr(a6) ;Quelladresse
                  bne.s    vrt_src_width
...
vrt_src_planes:   move.w   d7,r_splanes(a6) ;Anzahl der Bildebenen - 1
                  ...
                  move.l   fd_addr(a5),r_daddr(a6) ;Zieladresse
...
vrt_cpyfm_mono:   tst.w    d6             ;monochromes vrt_cpyfm?
                  ...
                  move.l   (mono_expblt).w,d6 ;Treiber vorhanden?
