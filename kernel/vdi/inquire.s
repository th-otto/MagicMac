...
vql_attributes:	movem.l	pb_intout(a0),a0-a1 ;intout/ptsout
...
vqm_attributes:	movem.l	pb_intout(a0),a0-a1 ;intout/ptsout
						move.w	m_type(a6),d0
						addq.w	#M_DOT,d0
...
vqt_attributes:	movem.l	pb_intout(a0),a0-a1 ;intout/ptsout
...
vqt_ext_italics:	btst		#2,d0 			;kursiv ?
						beq.s 	vqt_ext_bold
						add.w 	t_whole_off(a6),d2 ;zusaetzliche Breite
vqt_ext_bold:		btst		#0,d0 			;fett ?
						beq.s 	vqt_ext_rot
						lsr.w 	#1,d3
						mulu		t_thicken(a6),d3
						add.w 	d3,d2
vqt_ext_rot:		moveq 	#0,d0
						swap		d2
						clr.w 	d2
						swap		d2
...
vqt_width_type:	movea.l	t_offtab(a6),a0 ;Zeiger auf Charoffset-table
						...
						divu		t_iheight(a6),d0
						and.l 	#$ffff,d0		;oberes Wort loeschen
...
vqt_name_err:		moveq 	#1,d1 			;Default-Zeichensatznummer
						lea		font_hdr1,a0
...
vqt_fontinfo:		movem.l	d1-d4,-(sp)
						...
						moveq 	#0,d0 			;fuer Sonderfall t_height = 1
