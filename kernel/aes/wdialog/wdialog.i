...
DIALOG_rect:		DS.W	4	; GRECT			rect;			/* Dialogposition und -ausmasse (nicht mit border geschnitten) */

DIALOG_whdl:		DS.W	1	; WORD			whdl;			/* Fensterhandle */
DIALOG_kind:		DS.W	1	; WORD			kind;
DIALOG_border:		DS.W	4	; GRECT			border;			/* Fensterposition und -ausmasse (auf den Rand bezogen) */
