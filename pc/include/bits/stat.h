...
#define stat __mint_stat
#define fstat __mint_fstat
#define lstat __mint_lstat
#endif
#endif
...
struct stat {
  ...
  struct __st_mtim st_atim;	/* Time of last access, UTC.  */
#define st_atime	st_atim.u.tv_sec
  struct __st_mtim st_mtim;		/* Time of last data modification, UTC. */
#define st_mtime	st_mtim.u.tv_sec
  struct __st_mtim st_ctim;	/* Time of last status change, UTC.  */	
