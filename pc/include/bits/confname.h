...
enum
  {
	_PC_LAST = -1,	/* max limit # for pathconf - POSIX (!?) */
#define _PC_LAST _PC_LAST
	_PC_IOPEN_MAX,	/* internal limit on open files - NOT POSIX */
#define _PC_IOPEN_MAX _PC_IOPEN_MAX
...
#define _PC_NO_TRUNC _PC_NO_TRUNC
	_MINT_PC_NAME_CASE,	/* case-insensitive file-names */
#define _MINT_PC_NAME_CASE _MINT_PC_NAME_CASE

	/* not from MiNT-kernel */
    __PC_LIBC_FIRST = 1000,
...
enum
  {
	_SC_LAST = -1,			/* max limit # for sysconf - NOT POSIX */
#define _SC_LAST _SC_LAST
	_SC_MEMR_MAX,			/* memory regions per process - NOT POSIX */
#define _SC_MEMR_MAX _SC_MEMR_MAX
...
#define _SC_CHILD_MAX _SC_CHILD_MAX
	_SC_CLK_TCK,			/* clock ticks */
#define _SC_CLK_TCK _SC_CLK_TCK
	_SC_PAGE_SIZE,			/* pagesize */
#define _SC_PAGESIZE	_SC_PAGE_SIZE	
#define	_SC_PAGE_SIZE			_SC_PAGE_SIZE
	_SC_AVPHYS_PAGES,			/* available physical pages */
#define _SC_AVPHYS_PAGES _SC_AVPHYS_PAGES
	_SC_GETPW_R_SIZE_MAX,	/* passwd buffer size */
#define _SC_GETPW_R_SIZE_MAX _SC_GETPW_R_SIZE_MAX
	_SC_GETGR_R_SIZE_MAX,	/* group buffer size */
#define _SC_GETGR_R_SIZE_MAX _SC_GETGR_R_SIZE_MAX

	/* not from MiNT-kernel */
    __SC_LIBC_FIRST = 1000,
