...
/* Construct an `nl_item' value for `nl_langinfo' from a locale category
   ...
   indices.  */
#define _NL_ITEM(category, index)	((((nl_item)(category)) << 16) | (index))
...
#define _NL_ITEM(category, index)	((((nl_item)(category)) << 8) | (index))
#define _NL_ITEM_CATEGORY(item)		((int) (item) >> 8)
#define _NL_ITEM_INDEX(item)		((int) (item) & 0xff)
