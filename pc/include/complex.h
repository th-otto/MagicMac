...
#define _Mdouble_complex_ __double_complex_t
...
#define _Mdouble_complex_ __float_complex_t
...
# define _Mdouble_complex_ __long_double_complex_t
# define __MATH_PRECNAME(name)	name##l
# include <bits/cmathcalls.h>
#endif
#undef	_Mdouble_
#undef	_Mdouble_complex_
#undef	_Mdouble_complex_t
#undef	__MATH_PRECNAME
#undef	__MATHDECL_1
#undef	__MATHDECL
#undef	__MATHCALL
