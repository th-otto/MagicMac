...
#ifndef __2B_UNIVERSAL_TYPES__	/* nicht eingebunden? */
...
typedef struct
{
     WORD     cdecl (*ub_code)(struct __parmblk *parmblock);
     LONG     ub_parm;
} USERBLK;
...
#define	objc_wdraw( a, b, c, d, e ) \
			MT_objc_wdraw( a, b, c, d, e, 0L )
#define	objc_wchange( a, b, c, d, e ) \
			MT_objc_wchange( a, b, c, d, e, 0L )
#define	graf_wwatchbox( a, b, c, d, e ) \
			MT_graf_wwatchbox( a, b, c, d, e, 0L )
#define	form_wbutton( a, b, c, d, e ) \
			MT_form_wbutton( a, b, c, d, e, 0L )
#define	form_wkeybd( a, b, c, d, e, f, g ) \
			MT_form_wkeybd( a, b, c, d, e, f, g, 0L )
#define	objc_wedit( a, b, c, d, e, f ) \
			MT_objc_wedit( a, b, c, d, e, f, 0L )
...
extern WORD	MT_graf_rubberbox( WORD gr_rx, WORD gr_ry, WORD gr_minwidth,
                    ...
                    WORD *gr_rlastheight, WORD *global );
extern WORD	MT_graf_dragbox( WORD w, WORD h, WORD begx, WORD begy, GRECT *g, WORD *endx, WORD *endy, WORD *global );
extern WORD	MT_graf_movebox( WORD gr_mwidth, WORD gr_mheight, WORD gr_msourcex, int gr_msourcey, int gr_mdestx, int gr_mdesty, WORD *global );
...
extern WORD	MT_graf_slidebox( OBJECT *gr_slptree, WORD gr_slparent, WORD gr_slobject, WORD gr_slvh, WORD *global );
extern WORD	MT_graf_handle( WORD *gr_hwchar, WORD *gr_hhchar, WORD *gr_hwbox, int *gr_hhbox, WORD *global );
extern WORD	MT_graf_xhandle( WORD *wchar, WORD *hchar, WORD *wbox, WORD *hbox, WORD *dev, WORD *global );    /* KAOS 1.4    */
extern WORD	MT_graf_mouse( WORD gr_monumber, MFORM *gr_mofaddr, WORD *global );
...
extern WORD	MT_wind_get_int( WORD whdl, WORD subfn, WORD *g1, WORD *global );
...
extern WORD	MT_wind_set_ptr_int( WORD whdl, WORD subfn, void *s, WORD i, WORD *global );
...
#define	wind_set_ptr_int( a, b, c, d ) \
			MT_wind_set_ptr_int( a, b, c, d, 0L )
...
extern WORD	MT_fslx_getnxtfile( FSLX_DIALOG fsd, char *fname, WORD *global );
extern WORD	MT_fslx_close( FSLX_DIALOG fsd, WORD *global );
extern WORD	MT_fslx_set_flags( WORD flags, WORD *oldval, WORD *global );

#define	fslx_open(a,b,c,d,e,f,g,h,i,j,k,l,m) \
			MT_fslx_open(a,b,c,d,e,f,g,h,i,j,k,l,m,0L)
#define	fslx_evnt(a,b,c,d,e,f,g,h) \
			MT_fslx_evnt(a,b,c,d,e,f,g,h,0L)
#define	fslx_do(a,b,c,d,e,f,g,h,i,j,k,l,m) \
			MT_fslx_do(a,b,c,d,e,f,g,h,i,j,k,l,m,0L)
#define	fslx_close( a ) \
			MT_fslx_close( a, 0L )
#define	fslx_getnxtfile( a, b ) \
			MT_fslx_getnxtfile( a, b, 0L )
#define	fslx_set_flags( a, b ) \
			MT_fslx_set_flags( a, b, 0L )
...
WORD	MT_pdlg_save_default_settings( PRN_DIALOG *prn_dialog, PRN_SETTINGS *settings, WORD *global );
...
#define	pdlg_save_default_settings( a, b ) \
			MT_pdlg_save_default_settings( a, b, 0L )
...
#include	<mt_edit.h>		/* Editor-Funktionen */
