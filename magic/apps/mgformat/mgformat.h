...
/* [1][TemporÑrlaufwerk ungÅltig!][Abbruch] */

#define AL_DEL_ALL         1 /* Alert string */
/* [2][Alle Daten auf Laufwerk %c:|werden gelîscht!][OK|Abbruch] */

#define AL_COMPLETE        2 /* Alert string */
/* [1][FORMAT:|Formatieren beendet.][ OK ] */

#define AL_BREAK           3 /* Alert string */
/* [3][FORMAT:|Formatieren abgebrochen.][ OK ] */

#define AL_DISKCP_COMPL    4 /* Alert string */
/* [1][DISKCOPY:|Disketten Kopieren beendet.][ OK ] */

#define AL_DISKCP_BREAK    5 /* Alert string */
/* [3][DISKCOPY:|Disketten Kopieren abgebrochen.][ OK ] */

#define AL_OPENWIND        6 /* Alert string */
/* [3][Fenster kann nicht geîffnet werden.][Abbruch] */

#define AL_ASK_BREAK       7 /* Alert string */
/* [1][FORMAT:|Vorgang abbrechen ?][  JA  | NEIN ] */

#define AL_OLD_OSVERSION   8 /* Alert string */
/* [3][FORMAT:|Alte OS- Version!][Abbruch] */

#define AL_DISK_IN_USE     9 /* Alert string */
/* [3][FORMAT:|Laufwerk ist in Benutzung!][Abbruch] */

#define AL_DSKNOTLOCKABL  10 /* Alert string */
/* [3][FORMAT:|Laufwerk kann nicht gesperrt werden!][Abbruch] */

#define AL_DSK_LOCKED_BY  11 /* Alert string */
/* [3][FORMAT:|Laufwerk gesperrt von %s.][Abbruch] */

#define AL_CAN_RETR_CONT  12 /* Alert string */
/* [2][FORMAT:|%s auf %c:][Abbruch|Nochmal|Weiter] */

#define AL_INSERT_DISK    13 /* Alert string */
/* [2][DISKCOPY:|%sdisk in %c: einlegen!][OK|Abbruch] */

#define AL_ASK_FORMAT     14 /* Alert string */
/* [2][DISKCOPY:|Formatieren ?][ OK |Abbruch] */
