...
* - 27.5.98
*		MT_appl_search korrigiert
* - 13.2.99
*		bfcolspec fÅr TEDINFO ergÑnzt
*		fslx_xx() verwendet FSLX_DIALOG statt ( void *)
* - 24.1.2000
*		fslx_getnxtfile() als Makro in MT_AES.H eingefÅgt
*
****************************************************************/
...
WORD MT_fslx_close( FSLX_DIALOG fsd, WORD *global )
{
	PARMDATA d;
