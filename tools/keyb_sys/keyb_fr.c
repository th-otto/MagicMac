...
char tab_shift[128] = {
 0,0x1b,'1','2','3','4','5','6','7','8','9','0','¯','_',0x08,0x09,
 'A','Z','E','R','T','Y','U','I','O','P','π','*',0x0d,0,'Q','S',
 'D','F','G','H','J','K','L','M','%','ú',0,'|','W','X','C','V',
 'B','N','?','.','/','+',0,0,0,0x20,0,0,0,0,0,0,
...
char tab_caps[128] = {
 0,0x1b,'&','Ç','"',0x27,'(','›','ä','!','á','Ö',')','-',0x08,0x09,
 'A','Z','E','R','T','Y','U','I','O','P','^','0x',0x0d,0,'Q','S',
 'D','F','G','H','J','K','L','M','ó','`',0,'#','W','X','C','V',
 'B','N',',',';',':','=',0,0,0,0x20,0,0,0,0,0,0,
