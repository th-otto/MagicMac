/*
*
* This program creates the keyboard table "KEYTABLS.SYS".
* The file must be placed in gemsys/magic/xtension.
*
* This is for the czech keyboard
*
* Version with dead keys for the "Apple Extended Keyboard"
* From UK version created by Petr Jand°k 28.04.2002
*/
...
char tab_dead[] = {
 '∫','‘','π','`',0,
'a','†','e','Ç','E','ê','i','°','l','ç','L','ä','n','Á','o','¢','r','´','s','‡','u','£','U','ó','y','ò','Y','ù','z','‰','Z','Â',0,
 'a','√','A','Õ','c','á','C','Ä','d','É','D','Ö','e','à','E','â','i','À','l','å','L','ú','o','ì','O','ß',
'n','§','N','•','r','©','R','™','s','®','S','õ','t','ü','T','Ü','u','ñ','U','¶','z','ë','Z','í',0,
 'a','Ñ','A','é','e','»','i',' ','o','î','u','Å',0,
 'a','ƒ','A','∂','e','…','i','Ã','o','–','u','“',0,0
};
...
int main( void )
{
	...
	if	(ret != 128L)
		goto wr_err;
	ret = Fwrite(hdl, sizeof(tab_dead), tab_dead);
	if	(ret != sizeof(tab_dead))
		goto wr_err;
