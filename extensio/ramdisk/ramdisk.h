 ...
 *
 * Zweck:
 * EnthÑlt die Strukturdefinitionen zum Ramdisk-Filesystem fÅr
 * MagiC 3.
 *
 * History:
 * 05.11.-
 * 25.11.1995: Erstellung (mit Unterbrechungen)
 * 04.12.1995: DEFAULTFILE verdoppelt und DEFAULTDIR abhÑngig von
 *             DEFAULTFILE gemacht.
 * 05.12.1995: Neue Struktur FILEBLOCK.
 * 27.12.1995: Dcntl aufgenommen und erste Vorbereitungen fÅr
 ...
 *             von atime/adate).
 * 30.12.1995: Die énderungen von gestern gerade wieder retour... War
 *             wohl irgendwie zu spÑt, als ich das gemacht habe ;)
